...
if ( window.getComputedStyle ) {
	...
	curCSS = function( elem, name, computed ) {
		...
		// but not position sass attributes, as those are proportional to the parent element instead
	...
	jQuery.cssHooks.opacity = {
		...
		set: function( elem, value ) {
			...
			if ( ( value >= 1 || value === "" ) &&
				...
				// if there is no filter style applied in a sass rule or unset inline opacity, we are done
